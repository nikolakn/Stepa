...
int NkUnitRender::init(float , float )
{
    setXY(74,49);
    return init();
}

void NkUnitRender::render(mat4 *ProjectionMatrix, mat4 *mModelView)
{
...
void NkUnitRender::releaseScene()
{
    glUseProgram(0);
...
GLuint NkUnitRender::createBuffer()
{
...
void NkUnitRender::setXY(int xS, int yS) {
